    ...
    <div id='cliente-create-modal' class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   <?php
	...
	'id'=>'cliente-create-form',
	'enableAjaxValidation'=>true,
        'enableClientValidation'=>true,
        'method'=>'post',
        'action'=>array("cliente/create"),
	'type'=>'horizontal',
	'htmlOptions'=>array(
...
function create()
 {
   ...
   var data=$("#cliente-create-form").serialize();
  ...
  jQuery.ajax({
   type: 'POST',
    url: '<?php
 echo Yii::app()->createAbsoluteUrl("cliente/create"); ?>',
   data:data,
success:function(data){
                //alert("succes:"+data); 
                if(data!="false")
                 {
                  $('#cliente-create-modal').modal('hide');
                  renderView(data);
...
{
  $('#cliente-create-form').each (function(){
  this.reset();
   });
