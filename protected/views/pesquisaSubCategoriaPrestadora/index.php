...
$this->breadcrumbs=array(
	'Pesquisa Sub Categoria Prestadoras',
);
...
<h1>Pesquisa Sub Categoria Prestadoras</h1>
<hr />
...
function delete_record(id)
{
 ...
 var data="id="+id;
  ...
  jQuery.ajax({
   type: 'POST',
    url: '<?php echo Yii::app()->createAbsoluteUrl("pesquisa-sub-categoria-prestadora/delete"); ?>',
   data:data,
