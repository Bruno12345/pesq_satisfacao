...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
 ...
 $this->renderPartial("_ajax_create_form",array("model"=>$model, 'oPesquisaForCreate' => $oPesquisaForCreate, 'listaCliente'=> $listaCliente));
...
function delete_record(id)
{
 ...
 var data="id="+id;
  ...
  jQuery.ajax({
   type: 'POST',
    url: '<?php echo Yii::app()->createAbsoluteUrl("pesquisa/delete"); ?>',
   data:data,
success:function(data){
                 if(data=="true")
                  {
