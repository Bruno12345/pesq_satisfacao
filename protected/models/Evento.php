...
class Evento extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, descricao, tag', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'periodoEventos' => array(self::HAS_MANY, 'PeriodoEvento', 'evento_id'),
			'eventoClientes' => array(self::HAS_MANY, 'EventoCliente', 'evento_id'),
		);
	}
